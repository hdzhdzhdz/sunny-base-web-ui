...
async function bootstrap(namespace: string) {
	...
	setupBusinessForm({
		config: {
			 ...
			 * @description 配置默认的上传和删除接口地址，所有 SunnySimpleUpload 组件都会使用这些配置
			 * @description Configure default upload and delete API endpoints, all SunnySimpleUpload components will use these configs
			 */
			uploadConfig: {
				/**
				 * 默认上传接口地址
